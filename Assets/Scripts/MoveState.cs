...
public class MoveState : IState
{
    ...
    public MoveState(MovementController controller, PlayerMovementStats moveStats)
    {
    ...
    private void HandleHorizontalMovement(float timeStep)
    {
        ...
        float acceleration = _moveStats.GroundAcceleration;
        float deceleration = _moveStats.GroundDeceleration;
